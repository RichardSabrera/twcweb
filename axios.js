...
//OBTENER NOSOTROS
axios.get('https://appapiwebtwc.azurewebsites.net/api/SiteWeb/Us')
    .then((respuesta) => {
...
axios.get('https://appapiwebtwc.azurewebsites.net/api/SiteWeb/Purpose')
    .then((respuesta) => {
...
//OBTENER BANNER
axios.get('https://appapiwebtwc.azurewebsites.net/API/SiteWeb/BANNER')
    .then((respuesta) => {
